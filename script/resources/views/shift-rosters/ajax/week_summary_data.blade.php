                        ...
                        <td class="px-1">
                            @if ($day == 'Leave')
                                <div data-toggle="tooltip" class="p-1 py-4 border badge badge-light f-10 border-danger w-100" data-original-title="@lang('modules.attendance.leave')"><i
                                        class="mr-2 fa fa-plane-departure text-red"></i>{{ $leaveType[$key2] }}</div>
                                @elseif ($day == 'Half Day')
                                    ...
                                    @endif
                                @elseif ($day == 'EMPTY')
                                    <button type="button" class="p-1 py-4 border change-shift-week badge badge-light f-14 w-100"  data-user-id="{{ $userId }}"
                                        data-attendance-date="{{ $key2 }}">
