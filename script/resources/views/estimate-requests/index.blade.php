...
@section('filter-section')
    ...
    <x-filters.filter-box>
        ...
        @else
            <input type="hidden" id="client" value="{{ user()->id }}">
        @endif
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker" id="filter-status">
                    ...
                    <option value="in process">@lang('app.inProcess')</option>
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between">
            <div id="table-actions" class="flex-grow-1 align-items-center mb-2 mb-lg-0 mb-md-0">
                ...
                @if ($addEstimatePermission == 'all' || $addEstimatePermission == 'added')
                    <x-forms.link-primary link="javascript:;" class="mr-3 float-left mb-2 mb-lg-0 mb-md-0" id="sendEstimateRequest" icon="link">
...
@push('scripts')
    ...
    <script>
        ...
        const showTable = () => {
            window.LaravelDataTables["estimate-request-table"].draw(false);
        }
        ...
        $('#estimate-request-table').on('change', '.change-status', function() {
