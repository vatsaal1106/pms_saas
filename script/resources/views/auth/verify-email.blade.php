...
<x-auth>
    ...
    <div class="alert alert-success" id="sessionCondition">
        <p>
            @if(session('user')->admin_approval === 0 && session('company')->approved === 0)
                @lang('superadmin.approvalPending')
            @elseif (session('user')->admin_approval === 0 && session('company')->approved === 1)
                @lang('superadmin.clientSignUpApprovalPending')
            @elseif (session('user')->admin_approval === 1 && session('company')->approved === 0)
                @lang('superadmin.signUpApprovalPending')
            @elseif (session('user')->admin_approval === 1 && session('company')->approved === 1)
