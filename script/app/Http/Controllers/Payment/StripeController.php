...
class StripeController extends Controller
{
    ...
    private function makeStripePayment($redirectRoute, $id)
    {
        ...
        return Reply::redirect(route(url()->temporarySignedRoute($redirectRoute, now()->addDays(\App\Models\GlobalSetting::SIGNED_ROUTE_EXPIRY), $id), $id), __('messages.paymentSuccessful'));
    }
