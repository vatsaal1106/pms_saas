...
class AttendanceByMemberExport implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function collection()
    {
        ...
        leftJoin('company_addresses', 'company_addresses.id', '=', 'attendances.location_id')
            ...
            ->select('attendances.clock_in_time as date', 'attendances.clock_in_time', 'attendances.clock_out_time', 'attendances.late', 'attendances.half_day', 'company_addresses.location', 'attendances.half_day_type')->get();
